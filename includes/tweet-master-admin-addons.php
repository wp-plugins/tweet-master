<?php
if( is_multisite() ) {
	function menu_multi_tweet_admin_addons(){
	// Create menu
...
<h2><b>&nbsp;<?php echo get_option('tweet_master_name'); ?> Add-ons</b></h2>
<?php
if(!class_exists('tweet_master_admin_addons_table')){
	require_once( dirname( __FILE__ ) . '/tweet-master-admin-addons-table.php');
}
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_multi_tweet_admin_addons' );
}
else {
