...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			...
			<td class="column-columnname"style="vertical-align:middle"><h3>Tweet Master Buttons Widget</h3><p>"Use it if you love your wordpress website" Fast Loading Widget to display Tweet and Follow Button. Beefed-up with Via Twitter User, Hashtag and Recommend. Option to display buttons bubble count and username are included for professional max "viral" effectiveness.</p><p>The free version of the plugin includes this widget unrestricted, if you need to display Twitter viral buttons and love your wordpress, use this widget. Works great when published under any of the below widgets.</p><p>Navigate to your Widgets page and start using it.</p></td>
		</tr>
		<tr>
			...
			<td class="column-columnname"style="vertical-align:middle"><h3>Tweet Master Tweets Widget</h3><p>"Supreme" This Widget displays your Tweets by encapsulating and cleaning the twitter script even when twitter servers are responding slow. We achieved Incredible Fast Page Load Times and clean code for Perfect Google SEO, a must for professional wordpress websites.</p><p>Check the Add-ons Page.</p></td>
		</tr>
		<tr class="alternate">
			...
			<td class="column-columnname"style="vertical-align:middle"><h3>Tweet Master Twitter Lists Widget</h3><p>Now you can show off your Twitter Lists without slowing down your website, once again we encapsulated and cleaned the twitter script for optimal wordpress page load times and great google seo.</p><p>Show as many lists as you want by publishing more Tweet Master Twitter Lists Widgets without being afraid of bringing down your website.</p><p>Check the Add-ons Page.</p></td>
		</tr>
	</tbody>
</table>
<?php
