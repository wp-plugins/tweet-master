<?php
if( is_multisite() ) {
function menu_multi_tweet_master_admin(){
// Create menu
add_menu_page( 'Tweet Master', 'Tweet Master', 'manage_options', 'tweet-master', 'tweet_master_admin', plugins_url( 'tweet-master/images/techgasp-minilogo-16.png' ) );
}
}
else {
// Create menu
...
add_menu_page( 'Tweet Master', 'Tweet Master', 'manage_options', 'tweet-master', 'tweet_master_admin', plugins_url( 'tweet-master/images/techgasp-minilogo-16.png' ) );
		...
		///////////////////////
		if( is_multisite() ) {
		add_action( 'network_admin_menu', 'menu_multi_tweet_master_admin' );
		}
		else {
...
if(!class_exists('tweet_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/tweet-master-admin-table-header.php');
}
...
if(!class_exists('tweet_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/tweet-master-admin-table-news.php');
}
//Prepare Table of elements
